...
Please note that any typo or extra character (e.g. space) in the EC number field of the [uniq_ec.tsv](examples/01_customdb/uniq_ec.tsv) file may cause no synonyms to be returned from KEGG API.
